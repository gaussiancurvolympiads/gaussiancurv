...
<Row>   <Col lg={12} align='left'>
               <Card className="skill-nbcard">
                    ...
                    <Card.Header><div class= "lead"><h5>Starting Works and Experience</h5></div></Card.Header>      <Card.Body> 
                     <Card.Text align="left" class={darkMode? "text-secondary" : "text-light"}> Along the start of the Gaussian Curvature Project from our whole hard working and sincere team  of GC some peoples deserves a special mention in GC, six of my friends <b className="footer-text">Orestis Lignos, Agamjeet Singh, Agaman Chatterjee, Papon Lapate, i3435, Arkan Manva</b>  who are the founder team members who helped in their all ways with me to curve the GC in a elegant way. As time past we improved our methods and new members were added in GC,  when other
